...
const DrawerCollapseButton = React.forwardRef<HTMLButtonElement, DrawerCollapseButtonProps>(({ isDrawerOpen }, ref) => (
  <StyledButton size="small" disableRipple>
    {isDrawerOpen ? <ChevronLeftRoundedIcon /> : <ChevronRightRoundedIcon />}
  </StyledButton>
));

DrawerCollapseButton.displayName = "DrawerCollapseButton";
